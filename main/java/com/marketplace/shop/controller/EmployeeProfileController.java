...
public class EmployeeProfileController implements Initializable {
    ...
    @FXML private TextField nameField, emailField, deptField, statusField,
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        deptField.setText(s(u.getDepartmentName()));
        statusField.setText(s(u.getStatusName()));
    ...
    private void handleSave() {
        ...
        try {
            ...
            u.setUserEmail(emailField.getText().trim());
